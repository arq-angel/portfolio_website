        ...
        <div class="row d-flex align-items-center">
            <div class="col-lg-6">
                <figure class="about-image">
                    <img src="{{ $about && $about->image ? asset($about->image) : asset('uploads/default/default-picture.webp') }}"
                         alt="{{ $about->title ?? 'About Image' }}" class="wow fadeInUp" data-wow-delay="0.3s">
                </figure>
            </div>
            <div class="col-lg-6">
                <div class="about-text">
                    ...
                    <div class="desc wow fadeInUp" data-wow-delay="0.4s">
                        <p>{!! $about && $about->description ? $about->description : 'No description available.' !!}</p>
                    </div>
