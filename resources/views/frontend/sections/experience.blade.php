        ...
        <div class="row d-flex align-items-center">
            <div class="col-lg-6 d-none d-lg-block">
                <figure class="single-image wow fadeInLeft">
                    <img src="{{ $experience && $experience->image ? asset($experience->image) : asset('uploads/default/default-picture.webp') }}" alt="{{ $experience->title ?? 'Experience Image' }}">
                </figure>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="icon-info wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <h6>
                                    <a href="tel:{{ $experience->phone ?? '#' }}" class="text">{{ $experience->phone ?? 'No phone number available' }}</a>
                                </h6>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="icon-info wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <h6>
                                    <a href="mailto:{{ $experience->email ?? '#' }}" class="text">{{ $experience->email ?? 'No email available' }}</a>
                                </h6>
                            </div>
                        </div>
                    </div>
