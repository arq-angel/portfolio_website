                            ...
                            <form method="POST" action="{{ route('password.store') }}" class="needs-validation"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password" type="password" class="form-control" name="password"
                                           value="{{old('password', $request->password)}}" tabindex="1" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password_confirmation" type="password" class="form-control" name="password_confirmation"
                                           value="{{old('password_confirmation', $request->password_confirmation)}}" tabindex="1" required autofocus>
